...
\include{1 Summary.tex}
% \include{2 Changes.tex}
% \include{3 Supporting Technologies.tex}
% \include{4 Notation and Acronyms.tex}
% \include{5 Acknowledgements.tex}
...
\mainmatter
\include{6 Contextual Background.tex}
\include{7 Technical Background.tex}
\include{8 Project Execution.tex}
\include{9 Main Body.tex}
\include{10 Critical Evaluation.tex}
\include{11 Conclusion.tex}
% =============================================================================
